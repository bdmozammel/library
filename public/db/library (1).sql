...
--
-- Table structure for table `e_rejects`
--
...
--
-- Dumping data for table `e_rejects`
--
...
--
-- Table structure for table `reject_entries`
--

CREATE TABLE `reject_entries` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Indexes for table `reject_entries`
--
ALTER TABLE `reject_entries`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `reject_entries`
--
ALTER TABLE `reject_entries`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
